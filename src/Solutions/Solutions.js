          ...
          <div className="Solutions__features">
            <div className="Solutions__features-item">
              ...
              <div className="Solutions__features-box">
                <div className="Solutions__features-heading">
                  <img alt="" src={apiLogo} className="Solutions__features-icon_mob" />
                  <h3 className="Solutions__features-heading-text">API</h3>
                </div>
            ...
            <div className="Solutions__features-item">
              ...
              <div className="Solutions__features-box">
                <div className="Solutions__features-heading">
                  ...
                  <h3 className="Solutions__features-heading-text">iFrame</h3>
                </div>
            ...
            <div className="Solutions__features-item">
              ...
              <div className="Solutions__features-box">
                <div className="Solutions__features-heading">
                  ...
                  <h3 className="Solutions__features-heading-text">White Label</h3>
                </div>
